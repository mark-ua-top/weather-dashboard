    ...
    return (
        <section className="header">
            <div className="container header-container">
                ...
                {user
                    ? <button className="Header-sign-up-button" onClick={() => { logout(); localStorage.removeItem('authToken'); }}>Logout</button>
                    : <button className="Header-sign-up-button" onClick={onAuthClick}>Sign Up</button>
                }
                <img className="Header-user-image" src={avatar} alt="user-image" />
            </div>
        </section>
    );
};